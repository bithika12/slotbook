...
<main class="container white z-depth-1 center-align view-slot margin-bottom-4x">
	<div class="row heading">
		...
		@if(Auth::check())
		<a class="z-depth-1 margin-top-x waves-effect waves-light btn right col-s4 green accent-4 add-btn" href="{{URL('slot/new')}}"> <i class="material-icons left">launch</i> Book A Slot </a>
		@endif
	</div>
	<div class="row">
